        ...
        <section class="section">
            ...
            <div class="col-md-3">
                ...
                <ul class="list-group" id="list-users">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $groupedSenders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $chatRoomId => $senders): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <li class="list-group-item active mb-2">
                        <a href="#" class="d-flex align-items-center" data-chat-room-id="<?php echo e($chatRoomId); ?>">
                            <div class="avatar me-3">
                                <img src="./assets/compiled/jpg/1.jpg" alt="" style="width: 60px; height: 60px;">
                                <span class="avatar-status bg-success"></span>
                            </div>
                            <div class="flex-grow-1">
                                <span class="name"><?php echo e($orang[$chatRoomId]); ?></span>
                            </div>
                        </a>
                        </li>
            ...
            <div class="col-md-9">
                <?php $__currentLoopData = $groupedSenders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $chatRoomId => $senders): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-md-9" id="sender-information-<?php echo e($chatRoomId); ?>" style="display: none;">
                        <div class="card">
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">
                                <div class="media d-flex align-items-center">
                                    ...
                                    <h6 class="mb-0"><?php echo e($orang[$chatRoomId]); ?></h6>
                            ...
                            <li class="list-group-item bg-grey">
                                <ul class="list-unstyled mb-0">
                                    ...
                                    <?php if($c->chat_room_id == $chatRoomId): ?>
                                        <li class="mb-2">
                                            <div class="chat <?php echo e($c->pengirim == session('user')->_id ? '' : 'chat-left'); ?>">
                                                <div class="chat-body">
                                                <div class="chat-message"><?php echo e($c->pesan); ?></div>
                                                </div>
                                            </div>
                                        </li>
                                    <?php endif; ?>
...
</html><?php /**PATH D:\project akhir sem 3\freshCatch-app\freshCatch-app\resources\views/admin/chatAdmin.blade.php ENDPATH**/ ?>