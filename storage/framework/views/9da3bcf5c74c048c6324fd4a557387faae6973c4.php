...
<body>
    ...
    <div class="container-sm product-container">
        ...
        <div class="row mt-4">
            <!-- Produk -->
            <?php $__currentLoopData = $produk; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $fm): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col-md-3">
                    <div class="product-card">
                        <a href="/fishmarket/<?php echo e($fm->id); ?>" style="text-decoration: none; color: inherit;">
                            <div>
                                <img src="assets/img/produk/<?php echo e($fm->gambar); ?>" alt="Produk 1" class="img-fluid">
                                <h2 class="text-center"><?php echo e($fm->nama_produk); ?></h2>
                                <p class="text-center">Rp. <?php echo e($fm->harga); ?>/kg</p>
                                <p class="text-center"><?php echo e(substr($fm->deskripsi, 0, 52)); ?></p>    
                            </div>
                        </a>
                        <form action="<?php echo e(url('/cart/store')); ?>" method="POST">
                            ...
                            <input type="hidden" name="id_produk" value="<?php echo e($fm->id); ?>">
                            <input type="hidden" name="nama_produk" value="<?php echo e($fm->nama_produk); ?>">
                            <input type="hidden" name="harga" value="<?php echo e($fm->harga); ?>">
                            <input type="hidden" name="kuantitas" value="1"> <!-- Default quantity is set to 1 -->
                            <div class="text-center">
                                <button type="submit" class="btn btn-cart" onclick="addToCart('<?php echo e(session('id_user')); ?>', '<?php echo e($fm->id); ?>', '<?php echo e($fm->user_id); ?>')">
                                    Add to Cart
                                </button>
                            </div>
                        </form>
...
</html><?php /**PATH D:\project akhir sem 3\freshCatch-app\freshCatch-app\resources\views/fishmarket.blade.php ENDPATH**/ ?>