                    ...
                    <div class="modal fade" id="modalArtikel" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form id="formArtikel" action="<?php echo e(route('admin.updatefishinfo')); ?>" method="post" enctype="multipart/form-data">
            ...
            $('.edit').click(function() {
                ...
                $.ajax({
                    ...
                    success: function(res) {
                        ...
                        $('#currentImage').attr('src', "<?php echo e(asset('assets/img/artikel')); ?>/"+data.gambar); // Set the source of the image
...
</html><?php /**PATH D:\project akhir sem 3\freshCatch-app\freshCatch-app\resources\views/admin/fishinfo.blade.php ENDPATH**/ ?>