...
<body>
    ...
    <div class="container product-detail-container mb-5 mt-8">
        ...
        <div class="row">
            <div class="col-md-6">
                <img src="<?php echo e($market -> gambar); ?>" alt="Produk 1"
            ...
            <div class="col-md-6">
                ...
                <div class="text-left mt-4">
                    ...
                    <form method="POST" action="<?php echo e(url('/cart/store')); ?>">
                        <?php echo csrf_field(); ?>
                        <input type="hidden" name="productId" value="<?php echo e($market->id); ?>">
        ...
        <div class="row d-flex">
            ...
            <div class="col-md-2">
                <div class="product-card">
                    <a href="/fishmarket/<?php echo e($mf->gambar); ?>" style="text-decoration: none; color: inherit;">
                        <div>
                            <img src="image/jakub-kapusnak-vLQzopDRSNI-unsplash.jpg" alt="Produk 1" class="img-fluid">
                            <h2><?php echo e($mf->nama_produk); ?></h2>
                            <p><?php echo e($mf->harga); ?></p>
                            <p><?php echo e(substr($mf->deskripsi, 0, 50)); ?></p>
                        </div>
                    </a>
...
</html><?php /**PATH D:\project akhir sem 3\freshCatch-app (2)\freshCatch-app\resources\views/detailFishmarket.blade.php ENDPATH**/ ?>