                                            ...
                                            <div class="modal-content">
                                                ...
                                                <form>
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="mb-3">
                                                            <label for="harga" class="form-label">Product
                                                                Price:</label>
                                                        ...
                                                        <div class="mb-3">
                                                            <label for="dibuat" class="form-label">Created
                                                                At:</label>
                    ...
                    <div class="modal fade" id="modalProduct" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form id="formProduct" action="<?php echo e(route('admin.updateproduct')); ?>" method="post" enctype="multipart/form-data">
...
</html><?php /**PATH D:\project akhir sem 3\freshCatch-app (2)\freshCatch-app\resources\views/admin/product.blade.php ENDPATH**/ ?>