...
<body>
    ...
    <div class="container mt-5">
        ...
        <div class="row justify-content-center">
            <!-- Card 1 -->
            <?php $__currentLoopData = $farm; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $ar): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col-md-6 mb-4 d-flex justify-content-center">
                <a href="/fish-farm/<?php echo e($ar->id); ?>" style="text-decoration: none; color: inherit;">
                    <div class="card" style="">
                        <div class="row g-0">
                            <img src="assets/img/fishfarm/<?php echo e($ar->gambar); ?>" class="img-fluid rounded-start w-100 rounded-img"
                                    alt="gambar tambak">
                            <div class="col-md-8">
                                <div class="card-body">
                                    <h5 class="card-title"><?php echo e($ar->nama); ?></h5>
                                    <p class="card-text"><?php echo e(substr($ar->deskripsi, 0, 250)); ?></p>
                                    <p class="card-text">
                                        <small class="text-body-secondary me-3">
                                            <i class="fas fa-map-marker-alt me-2 fs-5 mb-2" style="color: #03c8ff;"></i> <?php echo e($ar->latitude); ?>

                                            <br>
                                            <i class="fas fa-user me-2 fs-5" style="color: #03c8ff;"></i><?php echo e($ar->kontak); ?>


                                        </small>
                                    </p>
                                    <div class="d-flex justify-content-end">
                                        <a href="<?php echo e($ar->link); ?>" class="btn btn-custom" id="b">Lihat di Maps</a>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <nav class="my-4" aria-label="Pagination">
            <ul class="pagination pagination-circle justify-content-center">
                ...
                <?php if($farm->onFirstPage()): ?>
                    <li class="page-item disabled">
                        <span class="page-link" aria-hidden="true"><i class="fas fa-angle-left"></i></span>
                    </li>
                <?php else: ?>
                    <li class="page-item">
                        <a class="page-link" href="<?php echo e($farm->previousPageUrl()); ?>" rel="prev" aria-label="Previous">
                ...
                <?php $__currentLoopData = $farm->getUrlRange(1, $farm->lastPage()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page => $url): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li class="page-item <?php echo e($farm->currentPage() == $page ? 'active' : ''); ?>">
                        <a class="page-link" href="<?php echo e($url); ?>">
                            <span class="page-number"><?php echo e($page); ?></span>
                        </a>
                    </li>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        
                
                <?php if($farm->hasMorePages()): ?>
                    <li class="page-item">
                        <a class="page-link" href="<?php echo e($farm->nextPageUrl()); ?>" rel="next" aria-label="Next">
...
</html><?php /**PATH D:\project akhir sem 3\freshCatch-app\freshCatch-app\resources\views/fishfarm.blade.php ENDPATH**/ ?>