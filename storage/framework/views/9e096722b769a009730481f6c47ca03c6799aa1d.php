...
<body>
    ...
    <div class="col-md-8 offset-md-2 mt-lg-4 mx-auto">
        <h1 class="text-center" style="margin-top: 90px"><?php echo e($fish->judul); ?></h1>
        <p class="text-muted text-center"><?php echo e($fish->tgl_publikasi); ?></p>
        <img src="<?php echo e(asset('assets/img/artikel/' . $fish->gambar)); ?>" class="img-fluid article-image mb-3" alt="Gambar Artikel">
    
        <!-- Deskripsi dengan beberapa paragraf -->
        <div style="text-align: justify;">
            <?php $__currentLoopData = explode("\n", $fish->deskripsi); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $paragraph): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <p style="text-indent: 30px; margin-bottom: 20px;"><?php echo e($paragraph); ?></p>
...
</html><?php /**PATH D:\project akhir sem 3\freshCatch-app\freshCatch-app\resources\views/detailFishinfo.blade.php ENDPATH**/ ?>