                    ...
                    <div class="mb-5" style="margin-top: 5rem;">
                        <div class="container border bg-body rounded-4 shadow-sm p-4 mt-4">
                            <div class="row flex-column">
                                <a href="#" class="text-decoration-none text-black edit" data-bs-toggle="modal" data-bs-target="#editProfileModal" data-id="<?php echo e(session('user')->_id); ?>">
                                    ...
                                    <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <form id="Formeditprofil" action="<?php echo e(route('editprofil')); ?>" method="POST" enctype="multipart/form-data">
                                                        <?php echo method_field('PUT'); ?> <!-- Menambahkan _method dengan nilai PUT -->
                                                        <?php echo csrf_field(); ?> 
                                ...
                                <a href="#" class="text-decoration-none text-black alamat" data-bs-toggle="modal" data-bs-target="#editAlamat" data-id="<?php echo e(session('user')->_id); ?>">
                                    <div class="col p-2 fs-5 d-flex align-items-center">
                                ...
                                <div class="modal fade" id="modalAlamat" tabindex="-1" aria-labelledby="changeAddressModalLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form id="formAlamat" action="<?php echo e(route('editalamat')); ?>" method="post" enctype="multipart/form-data">
...
</html><?php /**PATH D:\project akhir sem 3\freshCatch-app\freshCatch-app\resources\views/profil.blade.php ENDPATH**/ ?>