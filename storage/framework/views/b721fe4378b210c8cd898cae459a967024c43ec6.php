    ...
    <div class="custom-background">
        <div class="container-sm">
            ...
            <div class="row row-cols-1 row-cols-md-3">
                <?php $__currentLoopData = $artikel->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ar): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col">
                    <a href="/fishinfo/<?php echo e($ar->id); ?>" style="text-decoration: none; color: inherit;">
                        <div class="card h-100 small-card" style="background: none; border: none;">
                            <img src="assets/img/artikel/<?php echo e($ar->gambar); ?>" class="card-img-top" alt="Hollywood Sign on The Hill"
...
</html><?php /**PATH D:\project akhir sem 3\freshCatch-app\freshCatch-app\resources\views/index.blade.php ENDPATH**/ ?>