...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('style/produkdetail.css')); ?>">
...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
        <div class="container-md">
            ...
            <img src="<?php echo e(asset('image/logo romusha.png')); ?>" width="auto" height="40" alt="" >
            </a>
    ...
    <div class="container product-detail-container mb-5 mt-8">
        ...
        <div class="row">
            <div class="col-md-6">
                <img src="<?php echo e(asset('assets/img/produk/' . $market->gambar)); ?>" alt="Produk 1" class="img-fluid product-detail-image w-100">
            </div>
            
            <div class="col-md-6">
                <h2 class="mb-1"><?php echo e($market -> nama_produk); ?></h2>
                <div class="mb-3">
                ...
                <p class="mb-3 product-price"><?php echo e($market -> harga); ?></p>
                <div class="mb-3">
                ...
                <p class="mb-3"><?php echo e($market -> deskripsi); ?></p>

                <div class="text-left mt-4">
                    <form action="<?php echo e(url('/cart/store')); ?>" method="POST">
                        <?php echo csrf_field(); ?> <!-- Tambahkan token CSRF di sini -->
                        <input type="hidden" name="id_user" value="<?php echo e(session('id_user')); ?>">
                        <input type="hidden" name="id_produk" value="<?php echo e($market->id); ?>">
                        <input type="hidden" name="nama_produk" value="<?php echo e($market->nama_produk); ?>">
                        <input type="hidden" name="harga" value="<?php echo e($market->harga); ?>">
                        ...
                        <div class="text-left mt-4">
                            ...
                            <button type="submit" class="btn btn-cart" onclick="addToCart('<?php echo e(session('id_user')); ?>', '<?php echo e($market->id); ?>', '<?php echo e($market->user_id); ?>')">
    ...
    <div class="row mt-4">
        <div class="row d-flex">
            <div class="row row-cols-1 row-cols-md-2 row-cols-lg-5">
                <?php $__currentLoopData = $produk; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $mf): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-md-4 col-lg-3">
                        <div class="card product-card">
                            <a href="/fishmarket/<?php echo e($mf->id); ?>" style="text-decoration: none; color: inherit;">
                                <img src="<?php echo e(asset('assets/img/produk/' . $mf->gambar)); ?>" alt="Produk" class="card-img-top img-fluid">
                                <div class="card-body">
                                    <h5 class="card-title"><?php echo e($mf->nama_produk); ?></h5>
                                    <p class="card-text"><?php echo e($mf->harga); ?></p>
                                    <p class="card-text"><?php echo e(substr($mf->deskripsi, 0, 50)); ?></p>
                                </div>
                            </a>
                            <form action="<?php echo e(url('/cart/store')); ?>" method="POST">
                                <?php echo csrf_field(); ?> <!-- Add CSRF token here -->
                                <input type="hidden" name="id_user" value="<?php echo e(session('id_user')); ?>">
                                <input type="hidden" name="id_produk" value="<?php echo e($mf->id); ?>">
                                <input type="hidden" name="nama_produk" value="<?php echo e($mf->nama_produk); ?>">
                                <input type="hidden" name="harga" value="<?php echo e($mf->harga); ?>">
                                <input type="hidden" name="kuantitas" value="1">
                                <div class="text-center">
                                    <button type="submit" class="btn btn-cart" onclick="addToCart('<?php echo e(session('id_user')); ?>', '<?php echo e($mf->id); ?>', '<?php echo e($mf->user_id); ?>')">
                                        Add to Cart
                                    </button>
                                </div>
                            </form>
...
$(document).ready(function () {
        ...
        var price = parseFloat("<?php echo e($market->harga); ?>");
...
</html><?php /**PATH D:\Semester 3\Pemograman Web\freshCatch-app\resources\views/detailFishmarket.blade.php ENDPATH**/ ?>