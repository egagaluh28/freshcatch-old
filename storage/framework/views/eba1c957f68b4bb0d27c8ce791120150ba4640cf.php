                ...
                <section class="section">
                                                ...
                                                <form>
                                                    <div class="modal-body">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input type="text" class="form-control"
                                                                        id="fishFarmName" name="fishFarmName" required>
                                                                </div>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="mb-3">
                                                                    <label for="gpsLatitude" class="form-label">GPS
                                                                        Latitude or Google Maps Link:</label>
                                                                    <input type="text" class="form-control"
                                                                        id="gpsLatitude" name="gpsLatitude" required>
                                                                </div>
                                                                ...
                                                                <div class="mb-3">
                                                                    <label for="gpsLongitude" class="form-label">GPS
                                                                        Longitude:</label>
                                                                    <input type="text" class="form-control"
                                                                        id="gpsLongitude" name="gpsLongitude" required>
                                                                </div>

                                                                <div class="mb-3">
                                                                    <label for="operationTime"
                                                                        class="form-label">Operation Time:</label>
                                                                    <input type="text" class="form-control"
                                                                        id="operationTime" name="operationTime"
                                                                        required>
                                                                </div>
                                            ...
                                            echo '<td>';
                                                if (!empty($row->gambar)) {
                                                    if (is_string($row->gambar)) {
                                                        echo '<img src="image/' . $row->gambar . '" width="100" height="100">';
                                                    } else {
                    ...
                    <div class="modal" id="editModal">
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h4 class="modal-title">Edit Fish Farm</h4>
                                    ...
                                    <form>
                                        <div class="modal-body">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label for="fishFarmName" class="form-label">Fish Farm
                                                            Name:</label>
                                                        <input type="text" class="form-control" id="fishFarmName"
                                                            name="fishFarmName" required>
                                                    </div>
...
</html><?php /**PATH D:\project akhir sem 3\freshCatch-app (2)\freshCatch-app\resources\views/admin/fishfarm.blade.php ENDPATH**/ ?>