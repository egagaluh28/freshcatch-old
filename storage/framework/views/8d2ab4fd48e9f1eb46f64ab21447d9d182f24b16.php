                    ...
                    <div class="row gx-5"> 
                        <div class="col-lg-6 mb-4">
                            <div class="bg-image hover-overlay ripple shadow-2-strong rounded-5">
                                <img src="image/<?php echo e($ar->gambar); ?>" class="img-fluid" alt="Image 1"
                    ...
                    <div class="col">
                        <a href="/fishinfo/<?php echo e($ar->id); ?>" style="text-decoration: none; color: inherit;">
                            <div class="card h-100 small-card" style="background: none; border: none;">
                                <img src="image/<?php echo e($ar->gambar); ?>" class="card-img-top" alt="Hollywood Sign on The Hill" style="border-radius: 10px;" />
...
</html><?php /**PATH D:\project akhir sem 3\freshCatch-app (2)\freshCatch-app\resources\views/fishinfo.blade.php ENDPATH**/ ?>