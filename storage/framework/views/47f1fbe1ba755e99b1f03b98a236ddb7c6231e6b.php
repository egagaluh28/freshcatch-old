...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('style/detailfishfarm.css')); ?>">
            ...
            <div class="card-body">
                <div class="container mt-5">
                    <div class="row">
                        <div class="col-lg-6">
                            <!-- Gambar tempat -->
                            <img src="<?php echo e(asset('assets/img/fishfarm/' . $farm->gambar)); ?>" class="img-fluid" alt="Tempat">
                        </div>
                        <div class="col-lg-6">
                            <!-- Informasi tempat -->
                            <h2><?php echo e($farm->nama); ?></h2>
                            <div class="mb-3">
                                <i class="fas fa-map-marker-alt mr-2"></i>
                                <span><?php echo e($farm->alamat); ?></span>
                            </div>
                            <div class="mb-3">
                                <i class="fas fa-phone-alt mr-2"></i>
                                <span>Nomor Telepon: <?php echo e($farm->kontak); ?></span>
                            </div>
                            <div>
                            ...
                            <div class="mt-3">
                                <a href="<?php echo e($farm->link); ?>" class="btn btn-custom">
...
</html><?php /**PATH D:\project akhir sem 3\freshCatch-app\freshCatch-app\resources\views/detailfishfarm.blade.php ENDPATH**/ ?>