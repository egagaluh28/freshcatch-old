                        ...
                        <div class="modal fade" id="modalProduct" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form id="formPembudidaya" action="<?php echo e(route('admin.updateFishFarm')); ?>" method="post" enctype="multipart/form-data">
            ...
            $('#id').val(id);
                ...
                $.ajax({
                    ...
                    success: function(res) {
                        ...
                        $('#currentImage').attr('src', "<?php echo e(asset('assets/img/fishfarm')); ?>/"+data.gambar); // Set the source of the image
...
</html><?php /**PATH D:\project akhir sem 3\freshCatch-app\freshCatch-app\resources\views/admin/fishfarm.blade.php ENDPATH**/ ?>