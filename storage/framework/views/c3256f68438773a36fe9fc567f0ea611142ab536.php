                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-lg-3 col-md-12 mb-4 mb-lg-0">
                                    <!-- Image -->
                                    <?php if($c->produk && $c->produk->gambar): ?>
                                    <a href="<?php echo e(url('/fishmarket/' . $c->produk_id)); ?>" style="text-decoration: none; color: inherit;">
                                        <img src="<?php echo e(asset('assets/img/produk/' . $c->produk->gambar)); ?>" class="w-100" alt="Product Image" />
                                    ...
                                    <?php else: ?>
                                        ...
                                        <div class="bg-image">
                                            <img src="<?php echo e(asset('path/to/placeholder-image.jpg')); ?>" class="w-100" alt="Placeholder Image" />
                                        </div>
                                    <?php endif; ?>
                                    <!-- Image -->
                                </div>                    
                                ...
                                <?php if($c->produk): ?> <!-- Check if $c->produk is not null -->
                                    ...
                                    <form action="<?php echo e(route('cart.delete')); ?>" method="post">
                                        ...
                                        <input type="hidden" name="id_cart" value="<?php echo e($c->id); ?>">
                                        <input type="hidden" name="id_user" value="<?php echo e($c->user_id); ?>">
                                ...
                                <form action="<?php echo e(route('update-cart-quantity')); ?>" method="post">
                                    ...
                                    <div class="d-flex mb-4" style="max-width: 300px">
                                        ...
                                        <div class="form-outline text-center">
                                            <?php if($c->produk): ?> <!-- Check if $c->produk is not null -->
                                                <input id="quantity-input-<?php echo e($c->produk->id); ?>" min="1" name="quantity" value="<?php echo e($c->kuantitas); ?>" type="number" class="form-control"/>
                                                <label class="form-label mt-2" for="form1">Kuantitas /KG</label>
                                                <p class="text-start text-md-center">
                                                    <strong>Rp. <?php echo e($c->produk->harga * $c->kuantitas); ?></strong>
                                                </p>
                                            <?php else: ?>
                                                <!-- Handle the case where $c->produk is null (optional) -->
                                                <!-- You can display a message or handle it according to your needs -->
...
</html><?php /**PATH D:\project akhir sem 3\freshCatch-app\freshCatch-app\resources\views/cart.blade.php ENDPATH**/ ?>