            ...
            <div class="col-md-6 mb-4 d-flex justify-content-center">
                <a href="/fish farm/<?php echo e($ar->id); ?>" style="text-decoration: none; color: inherit;">
                    <div class="card" style="max-width: 540px; width: 100%;">
                        <div class="row g-0">
                            <div class="col-md-4">
                                <img src="image/<?php echo e($ar->gambar); ?>" class="img-fluid rounded-start"
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text">
                                        <small class="text-body-secondary">
                                            <i class="fas fa-map-marker-alt"></i> <?php echo e($ar->latitude); ?>

                                            <br>
                                            <i class="fas fa-user"></i><?php echo e($ar->kontak); ?>
...
</html><?php /**PATH D:\project akhir sem 3\freshCatch-app (2)\freshCatch-app\resources\views/fishfarm.blade.php ENDPATH**/ ?>