...
<head>
    ...
    <title>Dashboard Fresh Catch</title>
                        ...
                        <li class="sidebar-item  has-sub">
                            ...
                            <ul class="submenu ">
                                ...
                                <li class="submenu-item  ">
                                    <a href="/waitingPa" class="submenu-link"><i
                                            class="bi bi-wallet-fill fs-5 me-2 "></i>waiting payment</a>

                                </li>

                                <li class="submenu-item  ">
                                    <a href="packing.html" class="submenu-link"><i
                                            class="bi bi-box2-fill fs-5 me-2 "></i>Packing</a>

                                </li>

                                <li class="submenu-item  ">
                                    <a href="sent.html" class="submenu-link"><i
                                            class="bi bi-send-fill fs-5 me-2 "></i>Sent</a>

                                </li>

                                <li class="submenu-item  ">
                                    <a href="done.html" class="submenu-link"><i
...
</html><?php /**PATH D:\project akhir sem 3\freshCatch-app (2)\freshCatch-app\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>