                    ...
                    <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel33" aria-hidden="true">
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form id="formArtikel" action="<?php echo e(route('admin.updateFishFarm')); ?>" method="post" enctype="multipart/form-data">
...
</html><?php /**PATH D:\Semester 3\Pemograman Web\freshCatch-app\resources\views/admin/fishfarm.blade.php ENDPATH**/ ?>