        ...
        <section class="border-bottom pb-4 mb-5">
            <div id="myCarousel" class="carousel slide" data-mdb-ride="false">
                ...
                <div class="carousel-inner">
                    <?php $__currentLoopData = $artikel; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $ar): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($key < 3): ?>
                    <div class="carousel-item <?php echo e($key === 0 ? 'active' : ''); ?>" data-mdb-interval="10000">
                    <div class="row gx-5"> 
                        <div class="col-lg-6 mb-4">
                            <div class="bg-image hover-overlay ripple shadow-2-strong rounded-5">
                                <img src="assets/img/artikel/<?php echo e($ar->gambar); ?>" class="img-fluid" alt="Image 1"
                            ...
                            <div class="col-lg-6 mb-4">
                                ...
                                <h4><strong><?php echo e($ar->judul); ?></strong></h4>
                                <p class="text-muted">
                                    <?php echo e(substr($ar->deskripsi, 0,500)); ?>

                                </p>
                                <a href="/fishinfo/<?php echo e($ar->id); ?>" style="text-decoration: none; color: inherit;" class="btn link-underline-info">Read More</a>
                            </div>  
                        </div>
                    </div>
                    <?php endif; ?>
    ...
    <div class="custom-background">
        <div class="container-sm">
            ...
            <div class="row row-cols-1 row-cols-md-3 g-4">
                <?php $__currentLoopData = $artikel; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ar): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col">
                        <a href="/fishinfo/<?php echo e($ar->id); ?>" style="text-decoration: none; color: inherit;">
                            <div class="card h-100 small-card" style="background: none; border: none;">
                                <img src="assets/img/artikel/<?php echo e($ar->gambar); ?>" class="card-img-top" alt="Hollywood Sign on The Hill" style="border-radius: 10px;" />
                                <div class="card-body" style="color: white;">
                                    <h5 class="card-title"><?php echo e($ar->judul); ?></h5>
                                    <p class="card-text">
                                        <?php echo e(substr($ar->deskripsi, 0, 200)); ?>
            ...
            <nav class="my-4" aria-label="Pagination">
                <ul class="pagination pagination-circle justify-content-center">
                    <?php if($artikel->onFirstPage()): ?>
                        <li class="page-item disabled">
                            <span class="page-link"><i class="fas fa-angle-left"></i></span>
                        </li>
                    <?php else: ?>
                        <li class="page-item">
                            <a class="page-link" href="<?php echo e($artikel->previousPageUrl()); ?>" rel="prev"><i class="fas fa-angle-left"></i></a>
                        </li>
                    <?php endif; ?>
            
                    <?php $__currentLoopData = $artikel->getUrlRange(1, $artikel->lastPage()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page => $url): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li class="page-item <?php echo e($artikel->currentPage() == $page ? 'active' : ''); ?>">
                            <a class="page-link" href="<?php echo e($url); ?>"><?php echo e($page); ?></a>
                        </li>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            
                    <?php if($artikel->hasMorePages()): ?>
                        <li class="page-item">
                            <a class="page-link" href="<?php echo e($artikel->nextPageUrl()); ?>" rel="next"><i class="fas fa-angle-right"></i></a>
                        </li>
                    <?php else: ?>
                        <li class="page-item disabled">
...
</html><?php /**PATH D:\project akhir sem 3\freshCatch-app\freshCatch-app\resources\views/fishinfo.blade.php ENDPATH**/ ?>