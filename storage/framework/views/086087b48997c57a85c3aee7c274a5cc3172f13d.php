                ...
                <div class="col-12 col-lg-9">
                    <div class="row">
                        <div class="col-6 col-lg-3 col-md-6">
                            <a href="waiting-payment.html" class="card-link">
                                <div class="card">
                        ...
                        <div class="col-6 col-lg-3 col-md-6">
                            <a href="sent.html" class="card-link">
                                <div class="card">
                                    <div class="card-body px-4 py-4-5 d-flex align-items-center">
                                        <div
                                            class="col-md-4 col-lg-12 col-xl-12 col-xxl-5 d-flex justify-content-center">
                        ...
                        <div class="col-6 col-lg-3 col-md-6">
                            <a href="done.html" class="card-link">
                                <div class="card">
                                    <div class="card-body px-4 py-4-5 d-flex align-items-center">
                                        <div
                                            class="col-md-4 col-lg-12 col-xl-12 col-xxl-5 d-flex justify-content-center">
...
</html><?php /**PATH D:\project akhir sem 3\freshCatch-app (2)\freshCatch-app\resources\views/admin/waitingPayment.blade.php ENDPATH**/ ?>