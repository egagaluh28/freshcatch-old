                ...
                <div class="col-md-6">
                    ...
                    <div class="address mb-3 mt-3">
                        <div class="d-flex align-items-start jus mt-2">
                            ...
                            <div class="ms-3">
                                <p>
                                    <?php echo e((session('user')->nama)); ?><br>
                                    <?php echo e((session('user')->alamat)); ?>
                    ...
                    <div class="summary mt-3">
                        <table class="table table-custom">
                            ...
                            <tbody class="table-cus">
                                <?php $__empty_1 = true; $__currentLoopData = $waiting; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        <td><img src="<?php echo e($item->produk->product_image); ?>" alt="<?php echo e($item->produk->nama_produk); ?>" width="50"></td>
                                        <td><?php echo e($item->produk->nama_produk); ?></td>
                                        <td><?php echo e($item->produk->harga); ?></td>
                                        <td><?php echo e($item->kuantitas); ?></td>
                                        <td><?php echo e($item->kuantitas * $item->produk->harga); ?></td>
                                    </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                    <tr>
                                        <td colspan="5">No items in the order summary.</td>
                                    </tr>
                                <?php endif; ?>
                            </tbody>
...
</html><?php /**PATH D:\project akhir sem 3\freshCatch-app\freshCatch-app\resources\views/payment.blade.php ENDPATH**/ ?>