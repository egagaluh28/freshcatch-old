            ...
            <div class="col-md-12 col-lg-12 col-xl-10">
                <div class="card">
                    ...
                    <div class="card-body" style="height: 400px; overflow-y: auto;" data-mdb-perfect-scrollbar="true">
                        ...
                        <?php if($c->pengirim==session('user')->_id): ?>
                        <div class="d-flex justify-content-between">
                            <p class="small mb-1 text-muted"><?php echo e($c->waktu); ?></p>
                            <p class="small mb-1"><?php echo e($orang[$c->pengirim]); ?></p>
                        </div>
                        <div class="d-flex flex-row justify-content-end mb-4 pt-1">
                            <div>
                                <p class="small p-2 me-3 mb-3 text-white rounded-3"
                                    style="background-color: #33bbc5;"><?php echo e($c->pesan); ?></p>
                            </div>
                            <img
                        ...
                        <div class="d-flex flex-row justify-content-start">
                            <img
                                ...
                                alt="avatar 1" style="width: 45px; height: 100%;">
                            <div>
                                <p class="small p-2 ms-3 mb-3 rounded-3" style="background-color: #f5f6f7;"><?php echo e($c->pesan); ?></p>
                            </div>
                        </div>
                        <?php endif; ?>
                    ...
                    <div class="card-footer text-muted d-flex justify-content-start align-items-center p-3">
                        <form action="<?php echo e(url('/postchat')); ?>" method="post" class="d-flex flex-grow-1">
                            <?php echo csrf_field(); ?>
...
</html><?php /**PATH D:\project akhir sem 3\freshCatch-app\freshCatch-app\resources\views/chat.blade.php ENDPATH**/ ?>