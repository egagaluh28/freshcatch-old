                    ...
                    <div class="mb-5" style="margin-top: 5rem;">
                        <div class="container border bg-body rounded-4 shadow-sm p-4 mt-4">
                            <div class="row flex-column">
                                <a href="/editprofile/{id}" class="text-decoration-none text-black">
...
</html><?php /**PATH D:\project akhir sem 3\freshCatch-app (2)\freshCatch-app\resources\views/profil.blade.php ENDPATH**/ ?>