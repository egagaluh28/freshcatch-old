                ...
                <div class="mb-5" style="margin-top: 5rem;">
                    <div class="container border bg-body rounded-4 shadow-sm p-4 mt-4">
                        <div class="row flex-column">
                            <?php if(!empty(session('user'))): ?>
                                <a href="/editprofile/<?php echo e((session('user')->id)); ?>" class="text-decoration-none text-black">
...
</html><?php /**PATH D:\Semester 3\Pemograman Web\freshCatch-app\resources\views/profil.blade.php ENDPATH**/ ?>