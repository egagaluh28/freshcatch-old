...
<body>
    ...
    <div class="col-md-8 offset-md-2 mt-lg-4 mx-auto">
        ...
        <img src="<?php echo e(asset('image/' . $fish->gambar)); ?>" class="img-fluid article-image mb-3" alt="Gambar Artikel">
    
        <!-- Deskripsi dengan beberapa paragraf -->
        <?php $__currentLoopData = explode("\n", $fish->deskripsi); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $paragraph): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php if($index === 0): ?>
                <p style="text-indent: 30px;"><?php echo e($paragraph); ?></p>
            <?php else: ?>
                <p style="text-indent: 30px;"><?php echo e($paragraph); ?></p>
            <?php endif; ?>
...
</html><?php /**PATH D:\project akhir sem 3\freshCatch-app (2)\freshCatch-app\resources\views/detailFishinfo.blade.php ENDPATH**/ ?>